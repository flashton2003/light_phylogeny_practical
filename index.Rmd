...
Now, download the phylogenetic tree from [here](https://www.dropbox.com/s/ft731tm7lmtkc7c/dataset1.aln.nwk?dl=0), and a meta-data file with information on the geographic location from [here](https://www.dropbox.com/s/xjxldv8ds0wai40/geog_loc_microreact.csv?dl=0).
...
You can download the tree from [here](https://www.dropbox.com/s/ugni3gbt8uargbf/dataset2.aln.pretty.nwk?dl=0), the annotation for figtree from [here](https://www.dropbox.com/s/ylepng6vb7y71n5/annotation_figtree.txt?dl=0) and the annotation for phandango from [here](https://www.dropbox.com/s/2rwkqf3di7x0l7u/annotation_phandango.csv?dl=0)
